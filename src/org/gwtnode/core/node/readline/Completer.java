...
public abstract class Completer extends JavaScriptReturningFunctionWrapper<JsArrayString> {
    ...
    @Override
    public JsArrayString call(JavaScriptFunctionArguments args) {
        return onSubstring((String) args.get(0));
    }

    public abstract JsArrayString onSubstring(String substring);
}
