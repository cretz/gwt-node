...
public abstract class JavaScriptFunctionWrapper {
    ...
    public final native JavaScriptFunction getNativeFunction() /*-{
        var subObj = this.@org.gwtnode.client.JavaScriptFunctionWrapper::subObj;
        if (!subObj.func) {
            var wrapper = this;
            subObj.func = function() {
                wrapper.@org.gwtnode.client.JavaScriptFunctionWrapper::call(Lorg/gwtnode/client/JavaScriptFunctionArguments;)(arguments);
            }
        }
        return subObj.func;
    }-*/;
