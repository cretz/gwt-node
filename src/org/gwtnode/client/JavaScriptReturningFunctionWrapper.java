...
public abstract class JavaScriptReturningFunctionWrapper<T> {
    ...
    public final native JavaScriptReturningFunction<T> getNativeFunction() /*-{
        var subObj = this.@org.gwtnode.client.JavaScriptReturningFunctionWrapper::subObj;
        if (!subObj.func) {
            var wrapper = this;
            subObj.func = function() {
                return wrapper.@org.gwtnode.client.JavaScriptReturningFunctionWrapper::call(Lorg/gwtnode/client/JavaScriptFunctionArguments;)(arguments);
            }
        }
        return subObj.func;
    }-*/;
