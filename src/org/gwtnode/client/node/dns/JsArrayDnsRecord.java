...
public class JsArrayDnsRecord extends JsArrayMixed {
    ...
    public final MxRecord getMxRecord(int index) {
        return (MxRecord) getObject(index);
    }
    
    public final SrvRecord getSrvRecord(int index) {
        return (SrvRecord) getObject(index);
    }
}
