 ...
 * the License.
 */
package org.gwtnode.client.node.tty;
...
/**
 * The node.js
 * <a href="http://nodejs.org/docs/v0.5.6/api/tty.html">tty</a>
 * module.
 * 
 * @author Chad Retz
 */
public class Tty extends JavaScriptObject implements NodeJsModule {
    ...
    public final native TtyProcess open(String path, JsArrayString args) /*-{
        ...
        return @org.gwtnode.client.node.tty.TtyProcess::new(ILorg/gwtnode/client/node/childprocess/ChildProcess;)(
                ttyProc[0], ttyProc[1]);
    }-*/;
