...
public abstract class ResponseEventHandler extends JavaScriptFunctionWrapper {

	@Override
	public void call(JavaScriptFunctionArguments args) {
		NodeJsError error = args.get(0);
		if (error != null) onError(error);
		else onSuccess(args.<ResponseStatus> get(1));
	}

	public abstract void onSuccess(ResponseStatus response);
