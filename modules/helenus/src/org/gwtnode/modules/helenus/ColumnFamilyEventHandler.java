...
public abstract class ColumnFamilyEventHandler extends JavaScriptFunctionWrapper {

	@Override
	public void call(JavaScriptFunctionArguments args) {
		NodeJsError error = args.get(0);
		if (error != null) onError(error);
		else onSuccess(args.<ColumnFamily> get(1));
	}

	public abstract void onError(NodeJsError error);

	public abstract void onSuccess(ColumnFamily columnFamily);
}
