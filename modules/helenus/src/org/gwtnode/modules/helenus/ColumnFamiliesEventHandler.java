...
public abstract class ColumnFamiliesEventHandler extends JavaScriptFunctionWrapper {

	@Override
	public void call(JavaScriptFunctionArguments args) {
		NodeJsError error = args.get(0);
		if (error != null) onError(error);
		else onSuccess(new JsonStringObjectMap<ColumnFamily>(args.<JavaScriptObject> get(1)));
	}

	public abstract void onError(NodeJsError error);

	public abstract void onSuccess(JsonStringObjectMap<ColumnFamily> columnFamily);
}
