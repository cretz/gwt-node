...
public final class JsUtils {
	...
	public static JavaScriptObject asJSO(Object value) {
	...
	public static native JavaScriptObject asJSODate(double value) /*-{
  	return new Date(value);
	}-*/;

	public static native JavaScriptObject asJSOString(String value) /*-{
    return value;
	}-*/;

	public static native JavaScriptObject asJSOInt(int value) /*-{
    return value;
	}-*/;
	
	public static native JavaScriptObject asJSODouble(double value) /*-{
    return value;
	}-*/;

	public static native JavaScriptObject asJSOBoolean(boolean value) /*-{
  	return value;
	}-*/;
	
	public static native JavaScriptObject asJSOObject(Object value) /*-{
    return value;
	}-*/;

	public static JsArrayMixed asJSOArray(Object... value) {
	...
	public static JsArrayMixed asJSOArray(Iterable<?> value) {
		JsArrayMixed result = JavaScriptObject.createArray().cast();
		for (Object item : value)
			result.push(asJSO(item));
		return result;
	...
	public static native JsArrayMixed asArray(JavaScriptObject jso) /*-{
	...
	public static native JavaScriptObject getProperty(JavaScriptObject jso, String name) /*-{
