...
public abstract class BufferResponseEventHandler extends JavaScriptFunctionWrapper {

	@Override
	public void call(JavaScriptFunctionArguments args) {
		onEvent(args.<Buffer> get(0), args.<Response> get(1));
	}

	public abstract void onEvent(Buffer chunk, Response response);
}
